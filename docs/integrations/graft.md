...
Latest refresh, September 24, 2026: the public source produced **87 map files plus INDEX.md**, including modular character authoring, owner identity, the browser gateway, the account-review register, Sunny, Unity, import/recovery tools and tests. The graph contains 700 nodes and 1629 edges. Rebuild the local cache after updating. SQL migrations, PowerShell and HTML/CSS require direct inspection. The setup-time counts below are historical.
